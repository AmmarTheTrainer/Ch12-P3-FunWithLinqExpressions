...
namespace Ch12_P4_FunWithLinqExpressions
{
    class Program
    {
        ...
        {
            List<string> myCars = new List<String> { "Mehran", "Cultus", "Revo" };
            List<string> yourCars = new List<String> { "Cultus", "BMW", "Revo" };
        ...
        static void GetOverstock(ProductInfo[] products)
        {
            ...
            var overstock = from p in products
                            where p.NumberInStock > 25 && p.NumberInStock < 27
                            select p;
